...
---
<<<<<<< HEAD
```{r,warning=F,message=F,tidy=F,echo=F,eval=FALSE,error=FALSE}
library(reshape)
library(car)
library(DescTools)
library(ggplot2)
...
>>>>>>> 017c1da32a93684056b78078d1072b470cfd8ce3
...
```{r,warning=F,message=F,tidy=F,echo=T,error=FALSE}
